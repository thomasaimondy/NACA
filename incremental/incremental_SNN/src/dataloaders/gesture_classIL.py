...
class Gesture_pre(Dataset):
    def __init__(self, train_or_test, transform=None, target_transform=None):
        ...
        if os.getlogin() == 'jiashuncheng':
            roots = '/home/jiashuncheng/code/EAST/DATASETS/dvsgesture_1.pkl'
...
def get(seed=0, mini=False, fixed_order=False, pc_valid=0):
    ...
    dat['train'] = Gesture_pre('train', transform=transforms.ToTensor())
    dat['test'] = Gesture_pre('test', transform=transforms.ToTensor())
    data[0] = {}
