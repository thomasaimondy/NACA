...
class NetworkBuilder(nn.Module):
    ...
    def __init__(self, topology, input_size, input_channels, label_features, train_batch_size, train_mode, dropout,
                 conv_act, hidden_act, output_act, spike_window, device, thresh, randKill, lens, decay, xishuspike, xishuada, propnoise, dataset):
...
class RFC_block(nn.Module): 
    def __init__(self, in_features, out_features, bias, activation, dropout, dim_hook, label_features,
